...
class Budget : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnAddNewBudget: TextView = findViewById(R.id.btnAddNewBudget)
        btnAddNewBudget.setOnClickListener {
            // Create an Intent to start AddNewBudget activity
            val intent = Intent(this, AddNewBudget::class.java)
